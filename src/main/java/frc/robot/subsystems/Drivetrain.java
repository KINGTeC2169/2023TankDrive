...
public class Drivetrain extends SubsystemBase {
  ...
  public void rDrive(double power) {
    RS3.set(ControlMode.PercentOutput, power*0.7);
    RS2.set(ControlMode.PercentOutput, power*0.7);
    RM1.set(ControlMode.PercentOutput, -power*0.7);    
  ...
  public void lDrive(double power) {
    LS6.set(ControlMode.PercentOutput, -power*0.8);
    LS5.set(ControlMode.PercentOutput, -power*0.8);
    LM4.set(ControlMode.PercentOutput, power*0.8);
